 ...
 \<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">"
    H.html ! A.xmlns "http://www.w3.org/1999/xhtml" $ do
        H.head $ do
            ...
            H.link ! A.rel "stylesheet" ! A.type_ "text/css" ! A.href "/static/css/redmond/jquery-ui-1.10.4.custom.css"
            ...
            H.script ! A.type_ "text/javascript" ! A.src "/static/js/jquery-ui-1.10.4.custom.min.js" $ ""
